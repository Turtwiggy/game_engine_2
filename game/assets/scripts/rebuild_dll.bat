...
set DLL_SRC=%PROJECT%\build\game\src\dll_boundary\GameDLL.dll
set DLL_DST=%PROJECT%\build\game\src\engine\GameDLL.dll
...
pushd %PROJECT%
del C:\Programming\c++_game_engine_2\build\game\src\dll_boundary\GameDLL.pdb
